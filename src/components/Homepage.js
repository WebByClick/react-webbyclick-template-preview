    ...
    return (
        <div className="wrap">
            ...
            <div id="grid-content" className="content">
                ...
                <div id="pobyty-pro-skoly" className="grid-section grid-section-bright"
                    ...
                    <div className="container grid-container">
                        ...
                        <div className="row grid-row">
                            ...
                            <div className="row grid-row">
                                <div className="col-md-30 grid-cell grid-cell-column">
                                    <div className="row grid-row">
                                        <div className="col-md-60 col-xs-60 grid-cell grid-cell-empty"/>
                                    </div>
                                    <div className="row grid-row">
                                        ...
                                        <div className="col-md-60 grid-cell grid-cell-content">
                                            <div className="grid-component">
                                                <div className="grid-content grid-button grid-align-left "
                                                     data-grid-content="button">
                                                    <a href="#" target="_self"
                                                       className="btn btn-lg btn-br-sm btn-inv ">Lorem Ipsum</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row grid-row">
                                        <div className="col-md-60 grid-cell grid-cell-content">
                                            <div className="grid-component">
                                                <div className="grid-content grid-image  grid-align-center"
                                                     data-grid-content="image">
                                                    <img className="img-fluid" src="https://klikem.cz/img/grid-dnd.png"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div id="section2" className="grid-section grid-section-bright">
                    <div className="container grid-container">
                        <div className="row grid-row">
                            <div className="col-md-60 col-xs-60 grid-cell grid-cell-empty"/>
                        </div>
                        <div className="row grid-row">
                            <div className="col-md-60 grid-cell grid-cell-content">
                                <div className="grid-component">
                                    <div className="grid-content grid-heading editable-content  "
                                         data-grid-content="heading">
                                        <h1 className=" grid-align-center">Lipsum<br/></h1>
                                    </div>
                            ...
                            <div className="row grid-row">
                                <div className="col-md-6 grid-cell grid-cell-column">
                                    <div className="row grid-row">
                                        <div className="col-md-60 col-xs-60 grid-cell grid-cell-empty"/>
                                    </div>
                                    <div className="row grid-row">
        ...
        <span className="icon-wrapper icon-sm icon-br-sm icon-col ">
            <i className="fa fa-fax"></i>
                                ...
                                <div className="col-md-14 grid-cell grid-cell-column">
                                    <div className="row grid-row">
                                        <div className="col-md-60 col-xs-60 grid-cell grid-cell-empty"/>
                                    </div>
                                    <div className="row grid-row">
                                        <div className="col-md-60 grid-cell grid-cell-content">
                                            <div className="grid-component">
                                                <div
                                                    ...
                                                    data-grid-content="text">
                                                    <p className=" grid-align-center"><b>123 345 567</b><br/>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-60 grid-cell grid-cell-content">
                                            <div className="grid-component">
                                                <div
                                                    className="grid-content grid-text editable-content clearfix   grid-padding-top-1"
                                                    data-grid-content="text" >
                                                    <p className=" grid-align-center"><b><a
                                                        href="mailto:lorem@ipsum.com"
                                                        target="_self">lorem@ipsum.com</a></b><br/>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <span className="icon-wrapper icon-sm icon-br-sm icon-col ">
            <i className="fa fa-facebook"></i>
                                            ...
                                            <div className="grid-component">
                                                <div
                                                    ...
                                                    <p className=" grid-align-center"><b><a
                                                        ...
                                                        target="_blank" rel="noopener noreferrer" >www.facebok.com/lipsum</a></b><br/>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="row grid-row">
                                <div className="col-md-60 grid-cell grid-cell-content">
                                    <div className="grid-component">
                                        <div className="grid-content grid-divider "
                            ...
                            <div className="row grid-row">
                                <div className="col-md-60 grid-cell grid-cell-content">
                                    <div className="grid-component">
                                        <div
                                            className="grid-content grid-text editable-content clearfix" data-grid-content="text" >
                                            <p className=" grid-align-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row grid-row">
                                <div className="col-md-60 grid-cell grid-cell-content">
                                    <div className="grid-component">
                                        <div className="grid-content grid-button grid-align-center "
                                             data-grid-content="button">
                                            <a href="#" target="_self"
                                               className="btn btn-lg btn-br-sm btn-col ">Lorem ipsum</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
